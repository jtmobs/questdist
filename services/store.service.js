    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return User.findByIdAndUpdate(result.owner, {
            $set: {
              store: result._id
            }
          });
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Store.find().populate(["owner", {
            path: "products",
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return Store.findByIdAndUpdate(req.params.id, req.body);
        case 2:
          store = _context4.sent;
          updatedStore = req.body;
          if (!(!req.body.thumbnail && req.file)) {
            _context4.next = 8;
            break;
          }
          _context4.next = 7;
          return remove(store.thumbnail.public_id);
        case 7:
        ...
        case 8:
          ...
          _context4.next = 12;
          return Store.findByIdAndUpdate(req.params.id, updatedStore);
        case 12:
          res.status(200).json({
            acknowledgement: true,
            message: "Ok",
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Store.findByIdAndDelete(req.params.id);
        case 2:
        ...
        case 7:
          _context5.next = 9;
          return User.findByIdAndUpdate(store.owner, {
            $unset: {
              store: ""
            }
          });
