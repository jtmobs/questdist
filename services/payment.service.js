...
exports.createPayment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var lineItems, session, purchase;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          lineItems = req.body.map(function (item) {
            return {
              price_data: {
                currency: "usd",
                product_data: {
          ...
          return stripe.checkout.sessions.create({
            ...
            mode: "payment",
            success_url: "".concat(process.env.ORIGIN_URL),
            cancel_url: "".concat(process.env.ORIGIN_URL)
          });
        case 3:
          ...
          return Purchase.create({
            ...
            products: req.body.map(function (item) {
              return {
                product: item.pid,
                quantity: item.quantity
              };
        ...
        case 9:
          ...
          req.body.forEach( /*#__PURE__*/function () {
          ...
          req.body.forEach( /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(cart) {
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return Cart.findByIdAndDelete(cart.cid);
                  case 2:
                  case "end":
            ...
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(product) {
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return Product.findByIdAndUpdate(product.pid, {
                      $push: {
                        buyers: req.user._id
                      }
                    });
