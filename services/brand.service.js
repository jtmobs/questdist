    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return User.findByIdAndUpdate(result.creator, {
            $set: {
              brand: result._id
            }
          });
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Brand.find().populate(["creator", {
            path: "products",
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          updatedBrand = req.body;
          if (!(!req.body.logo && req.file)) {
            _context4.next = 8;
            break;
          }
          _context4.next = 7;
          return remove(brand.logo.public_id);
        case 7:
          updatedBrand.logo = {
            url: req.file.path,
        ...
        case 8:
          ...
          _context4.next = 12;
          return Brand.findByIdAndUpdate(req.params.id, updatedBrand);
        case 12:
          res.status(200).json({
            acknowledgement: true,
            message: "Ok",
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Brand.findByIdAndDelete(req.params.id);
        case 2:
        ...
        case 7:
          _context5.next = 9;
          return User.findByIdAndUpdate(brand.creator, {
            $unset: {
              brand: ""
            }
          });
