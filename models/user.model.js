...
var userSchema = new mongoose.Schema({
  ...
  phone: {
    type: String,
    required: [true, "Please, provide your phone number, i.e.: +351xxxxxxxxx"],
    validate: {
      validator: function validator(value) {
        return _validator.isMobilePhone(value, "any", {
          strictMode: false
        });
      },
      message: "Phone number {VALUE} is not valid. Please, retry like +351xxxxxxxxx"
    },
    unique: true
  },
  // for role
